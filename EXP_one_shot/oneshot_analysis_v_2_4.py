# -*- coding: utf-8 -*-
"""
OneShot Analysis Pipeline v_2_4
===============================
...
v_2_3 CHANGES:
  - Added Panel 3.2a "Null Learning" (Blind vs Icon paired dot plot) to Figure 3.
    Uses results['q2'] from analyze_shape_effect(). Placed at axes[0,2].
  - Figure 3 expanded from 4x3 to 5x3 to accommodate the new panel.
    Layout: Row 0 [3.1, 3.2, 3.2a], Row 1 [3.2b, 3.2c, 3.2d],
    Row 2 [3.2e, 3.3, 3.4], Row 3 [3.5, 3.6, -], Row 4 [hidden].
...
def run_analysis(source=None, use_gui=False, output_dir=None,
    ...
    report(f"Version 2.1 | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    report("=" * 70)
