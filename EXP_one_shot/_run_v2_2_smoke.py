"""Smoke test for oneshot_analysis_v_2_2.
...
Data location resolution (first match wins):
  1. command-line argument: python _run_v2_2_smoke.py <glob_or_dir>
...
import oneshot_analysis_v_2_2 as m
...
# Confirm the new rare-mean column was computed.
print("sorted_est_rare_mean present:", 'sorted_est_rare_mean' in df.columns)
print("role_est_rare_mean present:", 'role_est_rare_mean' in df.columns)
